...
import { X, Calendar, GraduationCap, Briefcase, User } from 'lucide-react';
                        ...
                        <div className="grid gap-6">
                            ...
                            <div className="flex items-start gap-4 p-4 rounded-2xl bg-slate-800/50 border border-slate-700/50">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-slate-200 font-medium">{member.education || 'Not specified'}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 p-4 rounded-2xl bg-slate-800/50 border border-slate-700/50">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-slate-200 font-medium leading-relaxed">{member.work_history || 'Not specified'}</p>
                                </div>
                            </div>
                        </div>
                    </div>
